...
# Generate scatter plot for actual vs predicted prices
def generate_scatter_plot(y_test, predicted_prices_usd):
    # Create scatter plot
    plt.scatter(y_test, predicted_prices_usd)
    ...
    st.image('actual_vs_predicted_prices.png', caption='Actual vs Predicted House Prices')


# Streamlit user interface for predictions
st.title('House Price Prediction App (USD From Rupee)')
...
if st.button('Predict Price'):
    ...
    generate_scatter_plot(y_test, predicted_price_usd)
